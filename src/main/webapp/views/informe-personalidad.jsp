                        ...
                        <div class="table-responsive mt-3">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td>Resuelve con autonomía los problemas interpersonales que se le presentan</td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                    ...
                                    <tr>
                                        <td>Demuestra preocupación y solidaridad por los problemas de los demas</td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                ...
                                <tbody>
                                	<tr>
                                        <td>Desarrolla el trabajo escolar en forma sistémica y continua</td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                    ...
                                    <tr>
                                        <td>Intercambia conocimientos y materiales con sus compañeros</td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                    ...
                                    <tr>
                                        <td>Trata de superar las dificultades académicas que enfrenta</td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                    ...
                                    <tr>
                                        <td>Trabaja en clases en forma autónoma de acuerdo a las situaciones dadas</td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                    ...
                                    <tr>
                                        <td>Manifiesta disposición para acatar las normas en el ambito académico</td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
